...
async function app() {
    ...
    for (let line = 0; line < inputData.length; line++) {
        ...
        moveHead(currentHeadPosition, currentTailPosition, direction, steps)
    }
    console.log(currentHeadPosition, currentTailPosition)
    ...
    function moveTail(headPos: position, tailPos: position) {
